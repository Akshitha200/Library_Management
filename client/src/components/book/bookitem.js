...
const BookItem = (prod)=>{
    ...
    <img className="mt-1" ref={imgRef} src={`data:image/png;base64,${base64string}`} height="100px" width="auto" alt="no" onError={(e)=>{e.target.onerror=null;e.target.src=`default${Math.ceil(4*Math.random())}.webp`}} ></img>
